    ...
    return (
        <div className="w-full max-w-2xl mx-auto py-18 space-y-8 max-sm:absolute max-sm:top-1/2 max-sm:-translate-y-1/2 bg-white max-sm:max-w-sm max-sm:rounded-lg max-sm:px-7 max-sm:py-7">
            <div>
                ...
                <img className="mx-auto w-52 h-52 max-sm:w-40 max-sm:h-40" src={Logo} alt="Your Company" />
            ...
            <form className="mt-8 space-y-6" action="#" method="POST">
                ...
                <div className="-space-y-px rounded-md">
                    <div className="mb-3">
                        ...
                        />
                        {ruleUserName && (
                            <span className=" pl-2 text-red-600 font-semibold text-sm">
                                ! Your username needs to be at least 6 characters{' '}
                            </span>
                        )}
                    </div>
                    ...
                    <div className="pb-3">
                        ...
                        />
                        {ruleEmail && (
                            <span className=" pl-2 text-red-600 font-semibold text-sm mb-3">
                                ! Must be valid email{' '}
                            </span>
                        )}
                    </div>
                    ...
                    <div className="pb-3">
                        ...
                        {rulePassword && (
                            <span className=" pl-2 text-red-600 font-semibold text-sm">
                                ! Your password must be at least: 8 characters, One Uppercase, One Lowercase and One
                                Number{' '}
                            </span>
                        )}
                    </div>
                    ...
                    <div className="mb-3!important">
                        ...
                        {rulePasswordConfirm && (
                            <span className=" pl-2 text-red-600 font-semibold text-sm">
                                ! Your Password Confirm does not match
                            </span>
                        )}
                    </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center cursor-pointer" onClick={checkAcceptCondition}>
                        ...
                        <label htmlFor="remember-me" className="ml-2 block max-sm:text-xs text-sm text-gray-900">
                            I understand and accept with <br></br>
                            <a className=" text-indigo-600 cursor-pointer hover:underline font-semibold">
                                Terms of use
                            </a>{' '}
                            &{' '}
                            <a className=" text-indigo-600 cursor-pointer hover:underline font-semibold">
