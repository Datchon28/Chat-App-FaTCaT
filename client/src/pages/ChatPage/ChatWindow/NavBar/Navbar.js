...
function Navbar({ listChatAndRoom }) {
    return (
        ...
        {listChatAndRoom.map((list, index) => (
            <div key={index} className="user-info mr-80 max-h-navbar h-full w-chat-window-width flex items-center justify-between px-5 py-3 bg-color-sidebar fixed top-0 right-0 w" >
